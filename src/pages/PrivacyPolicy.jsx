                ...
                <Row>
                  ...
                  <div className="content-ask">
                    ...
                    <div className="ask-content3">
                                    ...
                                    <div className="ask-content2">
                                        <p>A : Modestravel menyediakan berbagai pilihan pembayaran melalui transfer Sesama/Antar Bank, Virtual Account, Payment Gateway hingga Internet Banking.
                                        </p>
                                    </div>
                                    <div className="ask-content3">
                    ...
                    <div  className="ask-content2">
                                    ...
                                    <div className="ask-content3">
                                        <p>Q : Apakah Solusi yang diberikan / ditawarkan oleh Modestravel.com?</p>
                                    </div>  
                                    <div className="ask-content2">
                                      <p>A : Modestravel memberikan solusi kepada :
                                            ...
                                            Modestravel Agent: Pemanfaatkan Umrahajj.co sebagai Mitra tanpa dipungut biaya apapun untuk mempromosikan paket perjalanan ibadah Umrah yang terdapat di Website Modestravel.com
                                                                        
                                    Untuk pendaftaran sebagai Modestravel agent silahkan klik link berikut : …………………………………….</p>
                                    </div>
    
                                    <div className="ask-content3">
                                        <p>Q : Apa Manfaat Membeli Paket Perjalanan Melalui Modestravel.com ?</p>
                                    </div>  
                                    <div  className="ask-content2">
                                    ...
                                    <div className="ask-content3">
                                        <p>Q : Mengapa Saya harus Menggunakan Layanan Modestravel.com?</p>
                                    </div>  
                    ...
                    <div className="ask-content3">
                                    ...
                                    <div  className="ask-content2">
                                        ...
                                        <br/>
                                            Anda dapat melakukan pembatalan paket Umrah dengan menghubungi call center Modestravel.comdengan tetap memperhatikan syarat dan ketentuan pembatalan paket Umrah dari PPIU bersangkutan.
                                        <br/>
