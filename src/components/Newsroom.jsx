  ...
  <div className="carousel-cell22">
    ...
    <div className="newsroom-text1">
      ...
      <a href={link} target="blank">
        <p className="neswroom-text2">More</p>
      </a>
    </div>
  </div>
);
  ...
  render() {
    ...
    if (this.state.posts != null) {
      cards = posts.map(post => {
        const imageUrl =
          post.better_featured_image.source_url !== null
            ? post.better_featured_image.source_url
            : "./another/image/as/placeholder.jpg";
        const imageCover = {
        ...
        return (
          <PostCard
            ...
            body={post.excerpt.rendered.trim().substring(0, 100)}
            imageUrl={".."}
          ...
          <Col md="12" lg="12" xs="12">
            <div className="homepage-newsroom hidden-xs">
              <Col
                ...
                sm="4"
                xs="12"
                className="content-homepage-newsroom-text"
              >
                <b>NEWS</b>
                <b> ROOM</b>
              ...
              <NavLink
                ...
                href="http://blog.modestravel.com"
                target="blank"
              >
                <Button type="Button" className="btn newsroom-btn">
                  see all
                </Button>
              </NavLink>
            </div>
