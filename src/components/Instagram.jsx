...
class Instagram extends React.Component {
  ...
  fetchFromApi() {
    axios({
      method: "GET",
      url:
        "https://api.instagram.com/v1/users/self/media/recent/?access_token=5689456550.1677ed0.18e17b78da5441858d86e91fbbd4f9cb"
    })
      .then(res => {
        this.setState({
          posts: [...res.data.data]
  ...
  render() {
    ...
    if (this.state.posts !== null) {
      cards = posts.map((post, index) => {
        if (index < 8) {
          ...
          return <PostCard imageUrl={".."} imageCover={imageCover} />;
        }
      });
    }
    ...
    return (
      <Container className="homepage-instagram">
        <Row>
          <Col md="1" lg="2" className="hidden-xs" />
        ...
        <NavLink
          ...
          href="https://www.instagram.com/modestravelofficial/"
          target="blank"
        >
          <Button type="Button" className="btn instagram-btn">
            see more
          </Button>
        </NavLink>
      </Container>
